...
🎯 Junior Business Analyst | DEBI Pre-Master Student
📍 Cairo, Egypt

## About Me
I'm a Junior Business Analyst with a background in Accounting 
and 4+ years of experience in sales and customer service.
Currently enrolled in the Business Analytics Pre-Master program 
at Digital Egypt Builders Initiative (DEBI).
...
- **Python** — Data Processing (in progress)

## 📂 Projects
| Project | Tools | Link |
|---|---|---|
| Sales Analysis Dashboard | Excel, Pivot Tables, Power Query | [View](#) |
| World Data Exploration | SQL, PostgreSQL | [View](https://www.db-fiddle.com/f/teuRYv6YW1a6dYQC6RJwxu/214) |
